...
/*
Method to display web development services
*/
...
skills.createProgressBar = function (divToAppend, percent, bgColor) {
  ...
  // this will create a static width. Disable and add the ease-out class
  ...
  if ( document.addEventListener ) { 
      // this is working on FFox and Chrome, and IE11  
...
skills.display(skills); // Why this method dont work when called on index.html -- ???
